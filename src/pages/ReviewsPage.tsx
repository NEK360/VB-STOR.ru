    ...
    <main className="min-h-screen pt-20 pb-32">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          ...
          <h1 className="text-white font-black text-4xl md:text-6xl tracking-tight mb-6">
            Отзывы
          </h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          {reviews.map((review, i) => (
            <motion.article
              ...
              className="glass rounded-2xl p-6 border border-white/6 hover:border-white/12 transition-colors"
        ...
        >
          ...
          <p className="text-white/40 text-sm mb-6">
            Напишите нам в WhatsApp или Telegram — мы будем рады вашему отзыву
          </p>
